...
newGameBtn.addEventListener("click", () => {
  ...
  // const btns = document.getElementsByClassName('ship-btn')
...
function addClicks() {
  ...
  for (let i = 0; i < squares.length; i++) {
    squares[i].addEventListener("click", () => {
      // console.log(human.playerBoard.ships[0])

      // console.log(human.playerBoard.ships[0].coords)
  ...
  ptBt.addEventListener("click", function() {
  ...
  sub.addEventListener("click", () => {
    human.playerBoard.setHorizontal(human.playerBoard.ships[1]);
